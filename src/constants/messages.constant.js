...
export const ERROR_NOT_SAME_ID = "ID no es el mismo que tiene el usuario registrado" ;
...
export const ERROR_NOT_HAVE_PRIVILEGES = "No tiene los privilegios necesarios" ;
