...
export default class CartRouter extends BaseRouter {
    ...
    initialize() {
        ...
        this.addGetRoute("/", [], currentUser,(req, res) => this.#cartController.getAll(req, res));
        // this.addGetRoute("/", [USER], currentUser,(req, res) => this.#cartController.getAll(req, res));
        this.addPostRoute("/", [PREMIUM, ADMIN], currentUser,(req, res) => this.#cartController.createCart(req, res));
        ...
        this.addDeleteRoute("/:cid/product/:pid", [PREMIUM, ADMIN], currentUser,(req, res) => this.#cartController.deleteProductOfCart(req, res));
        this.addPutRoute("/:cid", [/*PREMIUM, ADMIN*/], currentUser,(req, res) => this.#cartController.updateCartWithArray(req, res));
        this.addPutRoute("/:cid/product/:pid", [/*USER*/], currentUser,(req, res) => this.#cartController.updateQuantityOfProductInCart(req, res));
        this.addDeleteRoute("/cart/:cid", [USER], currentUser,(req, res) => this.#cartController.deleteAllProductsOfCart(req, res));
        ...
        this.addGetRoute("/:cid/purchase", [], currentUser,(req, res) => this.#cartController.purchasingProcess(req, res));
